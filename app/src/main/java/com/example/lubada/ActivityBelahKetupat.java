...
public class ActivityBelahKetupat extends AppCompatActivity implements View.OnClickListener {
    // Deklarasi Variabel
    ...
    public void onClick(View v) {
        if (v == Hitung) {
            if (Diagonal1.length()==0 && Diagonal2.length()==0) {
                ...
                Toast.makeText(this, "Diagonal 1 Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
            } else if (Diagonal2.length()==0) {
                Toast.makeText(this, "Diagonal 2 Tidak Boleh Kosong", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Berhasil dihitung", Toast.LENGTH_SHORT).show();
                Double count1 = Double.valueOf(Diagonal1.getText().toString());
                Double count2 = Double.valueOf(Diagonal2.getText().toString());
                Double diag = count1 * count2;
                hasill = diag * 0.5;
